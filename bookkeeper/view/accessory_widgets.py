...
class DateWidget(QtWidgets.QDateEdit):
    def __init__(self, date: QtCore.QDate = QtCore.QDate.currentDate()):
        super().__init__(date)
...
class EditButton(QtWidgets.QPushButton):
    ...
    def __init__(self, index: int, on_click_signal: QtCore.SignalInstance):
...
class BudgetWidget(QtWidgets.QWidget):
    ...
    def set_expenses(self, expenses: list[int]):
